...
const UserPageTest = () => {
            ...
            <tbody>
              {users.map((user, index) => (
                <tr
                  ...
                  onClick={() => navigate(`/Users/AccessUser/Detail/${user.uid}`)}
                > 
  ...
  return (
    <div className="max-w-7xl mx-auto p-8 bg-gray-50 rounded-lg shadow-xl space-y-12">
      {/* Title Section */}
      <h2 className="text-4xl font-bold text-gray-800 mb-6">Access User List</h2>

      {/* Search and Add User Section */}
      <section className="flex items-center text-black justify-between mb-6">
        <div className="w-3/4">
